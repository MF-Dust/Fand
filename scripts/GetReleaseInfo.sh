...
jarName="Fand-$mcversion.jar"
leavesid="Fand-$BUILD_NUMBER-$commitid"
...
mv build/libs/Fand-Fandclip-"$gradleVersion"-mojmap.jar "$jarName"
{
  echo "name=$leavesid"
  echo "tag=$tagid"
  echo "jar=$jarName"
...
{
  echo "$leavesid [![download](https://img.shields.io/github/downloads/FandMC/Fand/$tagid/total?color=0)](https://github.com/FandMC/Fand/releases/download/$tagid/$jarName)"
  echo "====="
  echo ""
...
{
  echo -n "{\"content\":\"Fand New Release\",\"embeds\":[{\"title\":\"$leavesid\",\"url\":\"https://github.com/FandMC/Fand/releases/tag/$tagid\",\"fields\":[{\"name\":\"Changelog\",\"value\":\""
